      ...
      <Card className="mb-6">
        <CardContent className="space-y-4 p-4">
          ...
          <div className="flex gap-4 mt-4">
            <Button onClick={() => exportOdt(true)}>
              📄 Esporta tutte le candidature (.odt)
            </Button>
            <Button onClick={() => exportOdt(false)}>
              📄 Esporta solo inviate o successive (.odt)
            </Button>
          </div>
        </CardContent>
      </Card>
          ...
          <Card key={index} className="border border-gray-300">
            <CardContent className="p-4 space-y-2">
              ...
              <p className="text-gray-700">
                <strong>Azienda:</strong> {job.azienda}
                <br />
                <strong>Sede:</strong> {job.sede}
                <br />
